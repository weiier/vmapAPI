...
@Entity
@Table(name="tb_unit_change")
public class UnitChange {
	private int unitChange_id;
	...
	@Id
	@GeneratedValue
	public int getUnitChange_id() {
		return unitChange_id;
	}
	public void setUnitChange_id(int unitChange_id) {
		this.unitChange_id = unitChange_id;
	}
	...
	public int getHas_outdoor() {
		return has_outdoor;
	}
	public void setHas_outdoor(int has_outdoor) {
